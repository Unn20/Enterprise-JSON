...
public class JsonTransformerDecoratorMinify extends JsonTransformerDecorator {
    public JsonTransformerDecoratorMinify(JsonTransformer decoratedJson) {
        super(decoratedJson);
    }
